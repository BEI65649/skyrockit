...
//       const currentUser = await User.findById(req.session.user._id)
//       res.render('applications/index.ejs')
//     } catch (error) { //This will attempt to render the index.ejs, but if it unable to render it will instead catch the error console.log the error and redirect them to the sign int.
//       console.log(error);
//       res.redirect('/');
//     }
//   });
...
router.post('/', async (req, res) => {
  try {
    ...
    // applications array of the current user infomration
...
// controllers/applications.js
//edit- this function retrieve the application so that it can be edited. 
...
// controllers/applications.js`
//update- this function edits the application - aka the update 
